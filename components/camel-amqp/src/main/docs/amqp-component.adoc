...
| *camel.component.amqp.object-message-enabled* | Whether to enable sending and receiving JMS ObjectMessage. Disabled by default for security reasons; see JmsConfiguration#setObjectMessageEnabled(boolean). | false | Boolean
