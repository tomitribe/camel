...
// components: START
Number of Components: 307 in 207 JAR artifacts (26 deprecated)
...
`ejb:beanName` | 2.4 | *deprecated* The ejb component is for invoking EJB Java beans from Camel.
...
`mqtt:name` | 2.10 | *deprecated* Component for communicating with MQTT M2M message brokers using FuseSource MQTT Client.
...
`rmi:hostname:port/name` | 1.0 | *deprecated* The rmi component is for invoking Java RMI beans from Camel.
...
| link:../camel-core/src/main/docs/serialization-dataformat.adoc[Java Object Serialization] (camel-core) | 2.12 | *deprecated* Serialization is a data format which uses the standard Java Serialization mechanism to unmarshal a binary payload into Java objects or to marshal Java objects into a binary blob.
...
| link:../camel-core/src/main/docs/string-dataformat.adoc[String Encoding] (camel-core) | 2.12 | *deprecated* String data format is a textual based format that supports character encoding.
...
// others: START
Number of Miscellaneous Components: 43 in 43 JAR artifacts (12 deprecated)
